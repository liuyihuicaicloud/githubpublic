# source from https://github.com/horovod/horovod/blob/master/examples/tensorflow_synthetic_benchmark.py
# tensorflow-1.12, horovod: 0.15.2
""" An example of training tensorflow model with Horovod strategy by using synthetic data. """
